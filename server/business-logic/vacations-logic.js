...
async function getFollowersAmountForAllVacations() {
  ...
  // SELECT vacations.* , count(followers.vacationId) FROM vacations JOIN followers ON vacations.vacationId = followers.vacationId WHERE followers.userId = 2 /// plus followers better!
